...
def fix_csv_file(input_file_path, output_file_path):
    with open(input_file_path, 'r', encoding='utf-8') as in_file, open(output_file_path, 'w+', encoding='utf-8', newline='') as out_file:
...
fix_csv_file('./resources/genuine_accounts.csv/tweets.csv', './resources/genuine_accounts.csv/tweets_processed.csv')
